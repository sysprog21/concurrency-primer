...
Here, sleeping is only used to ensure the occurrence of the ABA problem.
In a real-world scenario, instead of sleeping, thread A could be paused by a context switch to another task, including preemption by a higher-priority task.
