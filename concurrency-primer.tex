...
\label{rmw}
% To add:
% 值得注意的是 atomic type 不僅是 RWM 的保證，也是前後執行順序的保證，那可以把他當作 memery barrier 嗎？
...
They behave equivalently to a \monobox{do while} loop. See \clang{}11 standard 6.5.2.4 and 6.5.16.2 for more details.

\subsection{Further improments}
